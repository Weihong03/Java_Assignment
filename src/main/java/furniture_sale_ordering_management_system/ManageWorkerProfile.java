...
public class ManageWorkerProfile extends javax.swing.JFrame {
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(830, 934, Short.MAX_VALUE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void jButton_deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_deleteActionPerformed
        ...
        if (selectedRow >= 0) {
            ...
            try (BufferedReader reader = new BufferedReader(new FileReader("D:/MyFirstJavaProject/src/main/java/Officer_Salesperson.txt"))) {
                String line;
            ...
            try (BufferedWriter writer = new BufferedWriter(new FileWriter("D:/MyFirstJavaProject/src/main/java/Officer_Salesperson.txt"))) {
...
private void refreshTable(ManageWorkerProfile currentInstance) {
    ...
    public void displayBookings() {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("D:/MyFirstJavaProject/src/main/java/Officer_Salesperson.txt"))) {
            String line;
